...
function generate_data() {
  ...
  if (bo.value == "1") {
    ...
    document.getElementById("badge_img").innerHTML = "";
    document.getElementById("badge_img").innerHTML =
      " <img  style=' text-align: left !important; height: auto; width: 80px; ' src='https://ipsystems-ph.github.io/email-signature-generator/assets/media/Updated-BD-Badge-for-Sales.png' /> <img  style=' text-align: left !important; height: auto; width: 80px; margin-left: 14px !important; ' src='https://ipsystems-ph.github.io/email-signature-generator/assets/media/sales-badge-2.png' />";
  } else if (bo.value == "3") {
    document.getElementById("badge_img").innerHTML = "";
    document.getElementById("badge_img").innerHTML =
      " <img  style=' text-align: left !important; height: auto; width: 80px; ' src='https://ipsystems-ph.github.io/email-signature-generator/assets/media/technical-badge.png' /> <img  style=' text-align: left !important; height: auto; width: 80px; margin-left: 14px !important; ' src='https://ipsystems-ph.github.io/email-signature-generator/assets/media/Updated-BD-Badge-for-Technical.png' />";
  }

  var mo = document.querySelector('input[name="mobile_option"]:checked');
  if (mo.value == "1") {
    document.getElementById("mobile_option_preview").innerHTML = "Mobile/Viber:";
  } else if (mo.value == "2") {
    document.getElementById("mobile_option_preview").innerHTML = "Mobile:";
  }
